<script lang="ts">
  ...
  import type { Package } from "@/lib/types/booking";

  export let packages: Package[] = [];
  export let selectedPkgId: string | null = null;
  export let onSelect: (id: string) => void = () => {};
  export let openTiersId: string | null = null;
  export let onToggleTiers: (id: string) => void = () => {};
</script>
  ...
  <div class="container">
    ...
    <ol class="pkg-editorial__list" role="list">
      {#each packages as pkg, i}
        ...
        >
          <!-- Media placeholder (swap for <img> once you pass image props) -->
          <div class="pkg-editorial__media">
            <div class="pkg-editorial__media-bg"></div>
          ...
          <div class="pkg-editorial__content">
            <div class="pkg-editorial__meta">
              ...
              <div class="pkg-editorial__meta-right">
                {#if pkg.featured}
                  <span class="pkg-editorial__tag label">Most Popular</span>
                {/if}
...
<style>
  ...
  .pkg-editorial__item:hover .pkg-editorial__media-bg {
  ...
  /* lucide-svelte renders an <svg> — target it via :global */
